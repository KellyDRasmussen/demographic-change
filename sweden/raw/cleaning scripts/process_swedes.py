...
with open('change_swedes.csv', 'r', encoding='iso-8859-1') as f:
    reader = csv.reader(f)
...
with open('change_swedes_clean.csv', 'w', encoding='utf-8', newline='') as f:
    writer = csv.writer(f)
...
print("Processing complete! Created change_swedes_clean.csv")
